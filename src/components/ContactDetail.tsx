  ...
  return (
    <div className="bg-white shadow rounded p-4">
      ...
      <div className="flex gap-2 border-b mb-4">
        {["datos", "interacciones", "etiquetas", "preferencias", "perfiles", "actividades"].map((t) => (
          <button
            key={t}
      ...
      {tab === "preferencias" && <TabPreferencias contactId={contact.id} />}
      {tab === "perfiles" && <TabPerfiles contactId={contact.id} />}
      {tab === "actividades" && <TabActividades contactId={contact.id} />}
